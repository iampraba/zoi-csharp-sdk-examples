    ...
    class PreviewDocument
    {
        static void execute(String[] args)
        {
            try
            {
                ...
                PreviewDocumentInfo previewDocumentInfo = new PreviewDocumentInfo();

                previewDocumentInfo.DocumentName = "Document Preview Name";

                parameters.DocumentInfo = previewDocumentInfo;
