        ...
        static void execute(String[] args)
        {
            try
            {
                ...
                if (responseStatusCode >= 200 && responseStatusCode <= 299)
                {
                    ...
                    Console.WriteLine("presentation id to be deleted - {0}", showResponse.DocumentId);

                    APIResponse<ShowResponseHandler> response1 = sdkOperations.DeletePresentation(showResponse.DocumentId);
                    ...
                    if (responseStatusCode >= 200 && responseStatusCode <= 299)
                    {
                        ...
                        Console.WriteLine("presentation delete status - {0}", deleteResponse.DocDelete);
                    }
                }
                else
                {
            ...
            {
                Console.WriteLine("Exception in deleting presentation - ", e);
            }
        }
