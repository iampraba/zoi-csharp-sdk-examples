        ...
        static void execute(String[] args)
        {
            try
            {
                ...
                if (responseStatusCode >= 200 && responseStatusCode <= 299)
                {
                    ...
                    Console.WriteLine("Sheet session id to be deleted - {0}", sheetResponse.SessionId);

                    APIResponse<SheetResponseHandler> response1 = sdkOperations.DeleteSheetSession(sheetResponse.SessionId);
                    ...
                    if (responseStatusCode >= 200 && responseStatusCode <= 299)
                    {
                        ...
                        Console.WriteLine("Sheet session delete status - {0}", deleteResponse.SessionDelete);
                    }
                }
                else
                {
